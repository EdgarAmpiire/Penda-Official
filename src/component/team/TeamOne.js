...
const TeamOne = () => {
    return (
        ...
        <div className="container">
            ...
            <p>Our talented team is made up of experts in their respective fields, each bringing a unique set of skills to the table. From creative direction to flawless execution, get to know the people behind Penda Agency’s success.</p>
            </div>
            <div className="row">
                {allData.map((data) => (
