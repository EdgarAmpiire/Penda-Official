                    ...
                    <div className="row">
                        <div className="col-xl-5 col-lg-6">
                            <div className="contact-form-box shadow-box mb--30">
                                <h3 className="title">Get a free Penda Agency quote now</h3>
                                <FormTwo />
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-6 offset-xl-1">
                            <div className="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
                                ...
                                <p>Our customer care is open from Mon-Fri, 8:00 am to 5:00 pm</p>
                                <h4 className="phone-number"><a href="tel:+256775408295">+256 775 408295</a></h4>
                            </div>
                            <div className="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
