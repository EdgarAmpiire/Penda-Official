...
import { FaFacebookF, FaLinkedin, FaInstagram, FaTiktok } from "react-icons/fa";
                        ...
                        <div className="col-xl-6 col-lg-5">
                            <div className="footer-widget border-end">
                                <div className="footer-newsletter">
                                    ...
                                    <p>We’d love to hear from you! Whether you have questions, want to discuss a project, or just want to say hi, our team is here to help. Reach out to us, and let’s start a conversation!</p>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="footer-copyright">
                                <span className="copyright-text">© {new Date().getFullYear()}. All rights reserved by <a href="https://deigntech.com/">Deign Technologies Limited</a>.</span>
                            </div>
                        </div>
                        <div className="col-md-6">
